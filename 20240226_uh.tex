...
\begin{frame}[c]
  ...
  \begin{itemize}
    ...
    \item \alert{Generate} new experimentally testable, physically plausible hypotheses: dictate experiment design
  \end{itemize}
  \note[item]{Now, experiments of course, provide us with direct evidence about the brain.}
  \note[item]{With technology like neuropixels, we are now generating more data on the brain than ever before.}
  ...
  \note[item]{Advantages of models: complete control, complete observability}
\end{frame}
\begin{frame}[c]
